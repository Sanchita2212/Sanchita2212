...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3>🥇 Winner — RocketRide Buildathon</h3>
      <p><b>Event:</b> <a href="https://www.devnovate.co/event/buildx-mumbai">RocketRide: From Idea to Million-Dollar App</a> (BVUDET Mumbai)</p>
    ...
    <td width="50%" valign="top">
      <h3>🥇 Best AI/ML Project — Zero's Arena 01</h3>
...
### 🩺 2. [Fingerprint Blood Group Detection](https://github.com/Sanchita2212/fingerbio-bloodgroup-app)
> **Stack:** `Python` • `PyTorch` • `CNN` • `Computer Vision` • `Data Processing`
...
### 🚨 3. [Elderly Fall Detection System](https://github.com/Sanchita2212/Elderly-Fall-Detection-System)
...
### 🚆 4. [Monorail Ticketing Mobile Application](https://github.com/Sanchita2212/monorailapp)
...
*“Passionate about building intelligent systems that solve real problems through clean code, continuous learning, and community collaboration.”*
